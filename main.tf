...
module "network_security_group2" {
  source = "./modules/network_security_group"

  nsg_name            = "xpeterraformpoc-nsg2"
  resource_group_name = module.resource_group_xpeterraformpoc3.resource_group_name
  location            = module.resource_group_xpeterraformpoc3.resource_group_location
